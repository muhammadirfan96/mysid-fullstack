...
class StatusHubDlmKels extends ResourceController
{
    use ResponseTrait;
    protected $modelName = 'App\Models\StatusHubDlmKelsModel';
    ...
    //     $data = [
    //         'status_hub_dlm_kel' => $this->request->getVar('status_hub_dlm_kel'),
    ...
    //     $rules = $this->model->myValidationRules;
    //     $rules['status_hub_dlm_kel'] = 'required';
    //     if (!$this->validate($rules)) return $this->fail($this->validator->getErrors());
