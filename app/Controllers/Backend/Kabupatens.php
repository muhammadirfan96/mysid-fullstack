...
class Kabupatens extends ResourceController
{
    use ResponseTrait;
    protected $modelName = 'App\Models\KabupatensModel';
    ...
    public function create()
    {
        ...
        $logo->move('img/logo/kabupaten', $namaFile);
    ...
    public function update($id = null)
    {
        ...
        if ($logo != '') {
            $namaFile = $logo->getRandomName();
            $data['logo'] = $namaFile;
            if (file_exists('img/logo/kabupaten/' . $findData['logo'])) {
                unlink('img/logo/kabupaten/' . $findData['logo']);
            }
            $logo->move('img/logo/kabupaten', $namaFile);
        }
