...
<body>
    ...
    <div style="margin-bottom: 14px;">
        <p style="margin: 0; text-indent: 40px;">Berdasarkan keterangan dari yang bersangkutan dan pengamatan kami bahwa yang bersangkutan memiliki usaha <?= ' ' . $nama_usaha ?>.</p>
    </div>
    <div style="margin-bottom: 14px;">
