...
<body>
    ...
    <div style="text-align: center; margin-bottom: 14px;">
        <p style="margin: 0; text-decoration: underline;">SURAT KETERANGAN TIDAK MAMPU</p>
    ...
    <div style="margin-bottom: 14px;">
        <p style="margin: 0; text-indent: 40px;">Nama tersebut diatas adalah benar warga Desa Bhone Kainsetala Kecamatan Bone Kabupaten Muna. Berdasarkan keterangan yang ada pada kami benar bahwa yang bersangkutan termasuk anggota keluarga tidak mampu.</p>
    </div>
    <div style="margin-bottom: 14px;">
        <p style="margin: 0; text-indent: 40px;">Demikian surat keterangan ini kami buat dengan sebenarnya dan diberikan kepada yang bersangkutan agar dapat dipergunakan sebagaimana mestinya.</p>
    </div>
    <div>
