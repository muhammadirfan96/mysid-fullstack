...
<body>
    ...
    <div style="margin-bottom: 14px;">
        <p style="margin: 0; text-indent: 40px;">Nama tersebut diatas adalah benar warga Desa Latompa Kecamatan Maligano Kabupaten Muna. Berdasarkan keterangan yang ada pada kami benar bahwa yang bersangkutan termasuk anggota keluarga tidak mampu.</p>
    </div>
    <div style="margin-bottom: 14px;">
