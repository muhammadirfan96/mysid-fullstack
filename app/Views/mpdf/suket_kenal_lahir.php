...
<body>
    ...
    <div style="margin-bottom: 14px;">
        <p style="margin: 0; text-indent: 40px;">Yang bertanda tangan di bawah ini, Kepala Desa Bhone Kainsetala Kecamatan Bone Kab. Muna menerangkan berdasarkan keterangan dari :</p>
    </div>
    <div style="margin-bottom: 14px;">
